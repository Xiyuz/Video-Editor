...
namespace DataStudioRecorder.MyControls
{
    public partial class MusicBar : UserControl
    {
        ...
        {
            barRect = new Rectangle(this.PlayButton.Width / 2 -3, (this.Height / 2 - BarWidth / 2), (this.Width - (this.PlayButton.Width / 2) * 2), BarWidth*2);
            //progress bar
            ...
            //do not change color for unplayed part
